...
function makeCube(){
	...
	var vcol1 = vec4.fromValues( 0.1, 0.2, 0.3, 1.0 );
	var vcol2 = vec4.fromValues( 0.4, 0.5, 0.6, 1.0 );
	var vcol3 = vec4.fromValues( 0.7, 0.8, 0.9, 1.0 );
	var vcol4 = vec4.fromValues( 0.9, 0.8, 0.7, 1.0 );
	var vcol5 = vec4.fromValues( 0.6, 0.5, 0.4, 1.0 );
	var vcol6 = vec4.fromValues( 0.3, 0.2, 0.1, 1.0 );
	var vcol7 = vec4.fromValues( 0.2, 0.4, 0.5, 1.0 );
	var vcol8 = vec4.fromValues( 0.5, 0.6, 1.8, 1.0 );
