...
function makeCube() {
    ...
    var vertexColors = [
        glMatrix.vec4.fromValues(0.5, 0.0, 0.0, 1.0),
        glMatrix.vec4.fromValues(0.1, 0.2, 0.3, 1.0),
        glMatrix.vec4.fromValues(0.4, 0.5, 0.6, 1.0),
        glMatrix.vec4.fromValues(0.7, 0.8, 0.9, 1.0),
        glMatrix.vec4.fromValues(0.8, 0.7, 0.6, 1.0),
        glMatrix.vec4.fromValues(1.0, 0.2, 0.5, 1.0),
        glMatrix.vec4.fromValues(0.1, 0.5, 1.0, 1.0),
        glMatrix.vec4.fromValues(0.4, 0.3, 0.2, 1.0)
    ];
